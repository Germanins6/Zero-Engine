...
ComponentMaterial::ComponentMaterial(GameObject* parent, const char* path, Texture* ourTexture) : Component(parent, ComponentType::MATERIAL){

	//Save path info for showing purpose and stores information about texture in TextureData structure
	texture_path = path;
	TextureData = ourTexture;
...
ComponentMaterial::~ComponentMaterial() {
	...
	ilDeleteImages(1, &TextureData->id);
	TextureData = nullptr;
